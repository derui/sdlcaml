...
lookup_info ml_symkey_trans_table[] = {
  ...
  {Val_int(MLTAG_SDLK_KP_0)          , SDLK_KP_0},
  {Val_int(MLTAG_SDLK_KP_1)          , SDLK_KP_1},
  {Val_int(MLTAG_SDLK_KP_2)          , SDLK_KP_2},
  {Val_int(MLTAG_SDLK_KP_3)          , SDLK_KP_3},
  {Val_int(MLTAG_SDLK_KP_4)          , SDLK_KP_4},
  {Val_int(MLTAG_SDLK_KP_5)          , SDLK_KP_5},
  {Val_int(MLTAG_SDLK_KP_6)          , SDLK_KP_6},
  {Val_int(MLTAG_SDLK_KP_7)          , SDLK_KP_7},
  {Val_int(MLTAG_SDLK_KP_8)          , SDLK_KP_8},
  {Val_int(MLTAG_SDLK_KP_9)          , SDLK_KP_9},
  ...
  {Val_int(MLTAG_SDLK_NUMLOCKCLEAR) , SDLK_NUMLOCKCLEAR},
  {Val_int(MLTAG_SDLK_CAPSLOCK)     , SDLK_CAPSLOCK},
  {Val_int(MLTAG_SDLK_SCROLLLOCK)   , SDLK_SCROLLLOCK},
  ...
  {Val_int(MLTAG_SDLK_PRINTSCREEN)  , SDLK_PRINTSCREEN},
