...
*)
external init: unit -> (unit, string) Sugarpot.Std.Either.t = "sdlcaml_ttf_init"
...
*)
external was_init: unit -> (bool, string) Sugarpot.Std.Either.t = "sdlcaml_ttf_was_init"
...
*)
external open_font: file:string -> ptsize:int -> (font, string) Sugarpot.Std.Either.t
...
external open_font_index: file:string -> ptsize:int -> index:int
  -> (font, string) Sugarpot.Std.Either.t = "sdlcaml_ttf_open_font_index"
...
external set_kerning: font -> bool -> unit  = "sdlcaml_ttf_set_kerning"

(** Enable the kerning setting of the loaded font

    @param font the loaded font
*)
let enable_kerning f = set_kerning f true

(** Disable the kerning setting of the loaded font

    @param font the loaded font
*)
let disable_kerning f = set_kerning f false
...
external render_utf8_solid: font:font -> text:string -> color:Sdl_video.color
  -> (Sdl_video.surface, string) Sugarpot.Std.Either.t = "sdlcaml_ttf_render_utf8_solid"
...
external render_utf8_shaded: font:font -> text:string -> fg:Sdl_video.color
  -> bg:Sdl_video.color
  -> (Sdl_video.surface, string) Sugarpot.Std.Either.t = "sdlcaml_ttf_render_utf8_shaded"
...
external render_utf8_blended: font:font -> text:string -> color:Sdl_video.color
  -> (Sdl_video.surface, string) Sugarpot.Std.Either.t = "sdlcaml_ttf_render_utf8_blended"
