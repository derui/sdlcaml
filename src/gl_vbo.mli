(** Some operations for Vertex Buffer Object in the OpenGL.
    Containing to generate buffer, bind buffer, and set data to buffer.
    You can use this module only if you built Sdlcaml with GL_VERSION_3_0 or above.
    If you did not build Sdlcaml with GL_VERSION_3_0, always raise exception when
    function called in this module.
