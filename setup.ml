...
(* OASIS_START *)
(* DO NOT EDIT (digest: f0f60ab55abbdb562f6bba1553982974) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          bugreports = None;
          synopsis = "SDL2 wrapper for OCaml";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [ExternalTool "omake"; ExternalTool "omake"]
                   })
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\190Fi0\238:\150\220\015\006\\#n\149\230b";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
